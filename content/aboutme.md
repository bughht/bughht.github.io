...
## Talks
+ **Prospective Correction of Fuzzy Ripple Artifacts in High-Resolution EPI using Dynamic Multi-Channel B₀ Field Control** — Pitch Presentation, Gordon Research Conference: In Vivo Magnetic Resonance, 2026. (Abstract #8)
...
+ [**PyBiotSavart**](https://github.com/bughht/PyBiotSavart) — A Python library designed to simulate and visualize magnetic fields generated by various coil configurations using the Biot-Savart law. It provides an easy-to-use interface for calculating magnetic fields and visualizing them in 3D space. With GPU acceleration powered by PyTorch, PyBiotSavart ensures faster computations for large-scale simulations.
...
+ **Haotian Hong**, Renzo Huber, Lincoln Craven-Brightman, Paul Dubovan, Theodore Brierre, Jason Stockmann, Bastien Guerin. "Active Compensation of Short-Term Eddy Currents in High-Resolution EPI Using a 31-Channel ACDC Shim Coil at 7T", Gordon Research Conference: In Vivo Magnetic Resonance, 2026. (Abstract #8)
